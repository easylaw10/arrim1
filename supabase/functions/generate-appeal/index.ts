        ...
        messages: [
          {
            ...
            הנחיות חשובות:
            1. אין לכלול פרטים אישיים של המערער בגוף הערר
            2. יש להתחיל את הערר עם "הנדון:" בלבד, ללא כותרות נוספות
            3. יש לכתוב את הטקסט בצורה רציפה וקוהרנטית, ללא שימוש בכוכביות, סלשים או סימני פיסוק מיוחדים
            4. יש להתייחס לכל אחד מהממדים (לשון, ארגון ותוכן) בנפרד ובפירוט
            5. יש לבסס כל טענה על דוגמאות ספציפיות מהמטלה
            6. יש להשתמש בשפה משפטית מקצועית ומדויקת
            7. יש לשמור על מבנה לוגי וברור
            8. יש להתייחס לציונים שניתנו ולהסביר מדוע הם אינם משקפים את רמת הכתיבה האמיתית
            9. יש לסכם בצורה משכנעת מדוע יש להעלות את הציון`
          },
          { 
            role: 'user', 
