    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white relative">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center space-y-8">
          ...
          <div className="mt-24 bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
            <h2 className="text-2xl md:text-3xl font-bold text-primary mb-8">איך זה עובד?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex items-center space-x-4 space-x-reverse">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold mb-2">מלא את פרטי הערר</h3>
                  <p className="text-gray-600">הזן את פרטיך האישיים וציוני המטלה</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 space-x-reverse">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold mb-2">המערכת מנתחת</h3>
                  <p className="text-gray-600">הבינה המלאכותית מנתחת את המידע</p>
                </div>
              </div>
              
              <div className="flex items-center space-x-4 space-x-reverse">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center text-primary font-bold">3</div>
                <div className="flex-1">
                  <h3 className="font-semibold mb-2">קבל את הערר</h3>
                  <p className="text-gray-600">קבל ערר מנומק ומפורט</p>
                </div>
              </div>
            </div>
          </div>
